...
Espol = resultado[resultado["UNIVERSIDAD"] == "UNIVERSIDAD POLITECNICA SALESIANA"]
analisis1 = Espol[Espol["CARRERA"] == "INGENIERIA DE SISTEMAS"]
analisis2= Espol[Espol["CARRERA"] == "INGENIERIA EN SISTEMAS"]
